	        ...
	        try { 
	            ...
	            $('#avatar').editable({  //头像可以编辑。
	                ...
	                url: function(params) {
						...
						// ***UPDATE AVATAR HERE*** //
						var submit_url = "${contextPath}" + "/sys/sysuser/uploadAttachement";//please modify submit_url accordingly头像上传的路径
						var deferred = null;
						var avatar = '#avatar';
						...
						if( "FormData" in window ) {
							...
							deferred = $.ajax({
										url: submit_url, //头像上传的路径
									   type: 'POST',
								processData: false,//important
								contentType: false,//important
								   dataType: 'json',//server response type
									   data: formData_object //上传的数据。要formdata类型
							})
						}
						else {
							deferred = new $.Deferred
